...
bool framelessWidget::nativeEvent(const QByteArray &eventType, void *message, long *result)
{
    ...
    if (msg->message == WM_USER + 1) {
        ...
        QString path = "E:/code/Qtcode/Audio-test-master/Audio/record/i am here.wav";
...
void framelessWidget::on_record_pushButton_released()
{
    ...
    //开始识别
    QString res;
    res = m_recognizer->runIAT("E:/code/Qtcode/Audio-test-master/Audio/record/output.wav");
    qDebug() << "识别结果：" << res;
    ...
    {
        // 设置Python脚本文件路径
        QString pythonScriptPath = "E:/code/Qtcode/Audio-test-master/Audio/scripts/openTxt.py";
    ...
    {
        // 设置Python脚本文件路径
        QString pythonScriptPath = "E:/code/Qtcode/Audio-test-master/Audio/scripts/openTxt2.py";
    ...
    {
        // 设置Python脚本文件路径
        QString pythonScriptPath = "E:/code/Qtcode/Audio-test-master/Audio/scripts/openWeb.py";
    ...
    {
        // 设置Python脚本文件路径
        QString pythonScriptPath = "E:/code/Qtcode/Audio-test-master/Audio/scripts/openWeb2.py";
...
//    m_recognizer->tts(&iflytek_result,&path);
    ...
    int tts_bool = m_recognizer->tts(src_text, "E:/code/Qtcode/Audio-test-master/Audio/record/iflytek_voice.wav");
    if (tts_bool == 0)
    {
        qDebug() << "语音合成成功！";
    }
    ...
    qDebug() << "ret"<< tts_bool;
    QString path = "E:/code/Qtcode/Audio-test-master/Audio/record/iflytek_voice.wav";
    multimedia->play(path);
    ui->paimeng_4->hide();
    ui->paimeng_1->hide();
    ui->paimeng_2->hide();
